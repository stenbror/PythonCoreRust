...
impl Expressions for PythonCoreParser {
    ...
    fn parse_expression_test(&mut self) -> Box<ASTNode> {
        ...
        match &*self.lexer.get_symbol() {
            ...
            _ => {
                let left_node = self.parse_expression_or_test();
                match &*self.lexer.get_symbol() {
                    Token::PyIf( .. ) => {
...
// #[cfg(test)]
// mod tests {
//     use crate::{ASTNode, Parser, Token};
...
//
//     #[test]
//     fn test_atom_elipsis() {
//         let mut lexer = Box::new( PythonCoreTokenizer::new("...".to_string()) );
//         let mut parser = PythonCoreParser::new(lexer);
//         let res = parser.parse_blocks_eval_input();
//         match *res {
//             ASTNode::EvalInput( 0u32, 3u32, a, b, c) => {
//                 let a1 = *a;
//                 match a1 {
//                     ASTNode::TestList( 0u32, 3u32, lst1, lst2 ) => {
//                         let el1 = lst1.get(0);
//                         match el1 {
//                             Some( x ) => {
//                                 match &**x {
//                                     ASTNode::AtomElipsis(0u32, 3u32, t1) => {
//                                         match &**t1 {
//                                             Token::PyElipsis(0u32, 3u32, None ) => {
//                                                 assert!(true)
//                                             },
//                                             _ => assert!(false)
//                                         }
...
//         let res = parser.parse_blocks_eval_input();
//         match *res {
//             ASTNode::EvalInput( 0u32, 5u32, a, b, c) => {
//                 let a1 = *a;
//                 match a1 {
//                     ASTNode::TestList( 0u32, 5u32, lst1, lst2 ) => {
//                         let el1 = lst1.get(0);
//                         match el1 {
//                             Some( x ) => {
//                                 match &**x {
//                                     ASTNode::AtomFalse(0u32, 5u32, t1) => {
//                                         match &**t1 {
//                                             Token::PyFalse(0u32, 5u32, None ) => {
//                                                 assert!(true)
//                                             },
//                                             _ => assert!(false)
//                                         }
