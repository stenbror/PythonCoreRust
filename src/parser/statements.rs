        ...
        match &*self.lexer.get_symbol() {
            Token::PyFinally( .. ) => {
                ...
                match &*self.lexer.get_symbol() {
                    ...
                    _ => {
                        panic!("Syntax Error at {} - Expected ':' in finally statement!", &self.lexer.get_position())
                    }
                }
            },
            _ => {
                panic!("Syntax Error at {} - Expected 'finally' in finally statement!", &self.lexer.get_position())
            }
        } 
    }
